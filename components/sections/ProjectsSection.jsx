  ...
  return (
    <section id="projects" className="relative py-20 px-6 bg-surface/30 flex flex-col items-center justify-center">
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        {/* Filter buttons */}
        <div className="flex flex-wrap justify-center gap-2 mb-8 animate-fade-in-delay-2">
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filtered.map((proj, i) => (
            <div key={proj.name} className="relative group bg-bg border border-border rounded-2xl shadow-lg p-0 flex flex-col overflow-hidden hover:shadow-2xl transition-all animate-fade-in-delay">
